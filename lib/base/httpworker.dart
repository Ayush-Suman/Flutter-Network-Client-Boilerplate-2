...
void init(ModelClassSelector modelClassSelector) async {
...
void _entryFunction(var meta) async{
  ...
  ModelClassSelector modelClassSelector = meta[1];
  ...
  await for(var message in receivePort){
    ...
    // Change this to Uri.http if the URL is http URL
    final Uri uri = Uri.https(URL,route, param);
